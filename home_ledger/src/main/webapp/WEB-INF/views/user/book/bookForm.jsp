...
<script type="text/javascript">
	$(document).ready(function(){
		// 자동 콤마
		$(".only_number_comma").each(function () {
	        var value = $(this).val();
		...
		$("#btnSave").on("click", function(){
			...
			var formData = new FormData($("#bookDetailForm")[0]);

			if(confirm("저장 하시겠습니까?")) {
				$.ajax({
				  url: "/user/book/saveBook.do",
				  type: "POST",
				  processData: false,
				  contentType: false,
				  data: formData,
...
<body class="common-page">
	<div class="menu-container">
	    ...
	    <div class="common_section">
            ...
            <form name="bookDetailForm" id="bookDetailForm">
	            <input type="hidden" id="hliSeq" name="hliSeq" value="${detail.hliSeq }" />
